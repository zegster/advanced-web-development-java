		...
		<div class="container">
			<table class="table table-dark table-striped">
				...
				<thead>
					...
					<tr>
						<td colspan="3" style="padding: 0">
							<form action="./search_list_math" method="post">
								<table class="table table-dark">
									<tr>
										<td width="20%" style="vertical-align: middle; text-align: center">
											<div class="form-check">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" name="isExact" value="true">&emsp;Exact search
												</label>
											</div>
										</td>
										...
										<td width="80%" class="text-center">
											<div class="input-group">
								        		<input type="text" name="keywordsearch" class="form-control" placeholder="Search problem by keyword">
							        			<button type="submit" class="btn btn-info" style="border-radius: 0 .25rem .25rem 0">
